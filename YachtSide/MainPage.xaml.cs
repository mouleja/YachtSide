...
namespace YachtSide
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            darkGreen = new SolidColorBrush() { Color = Colors.DarkGreen };

            RollButton.Focus(FocusState.Programmatic);
        }
        ...
        private void UpdateScores() // After each roll, updates the scores in each column not already used
        {
            ...
            if (!YatButton.IsEnabled && numberOfEach.Max() > 4)
            {
                ...
                {
                    p1yat.Text = (int.Parse(p1yat.Text) + 100).ToString();
                }
